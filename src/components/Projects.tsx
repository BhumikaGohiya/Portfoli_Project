  ...
  const technicalProjects = [
    {
      ...
      longDescription: "A comprehensive enterprise-grade REST API testing framework built with Rest Assured, featuring data-driven testing, modular architecture, and detailed reporting for scalable test automation.",
      technologies: ["Java", "Rest Assured", "TestNG", "Maven", "API Testing"],
      icon: Code,
      ...
      scope: "Enterprise REST API Testing",
      magnitude: "Multi-endpoint, data-driven tests",
      impact: "Scalable automated regression testing",
      liveDemo: "https://bhumikagohiya.github.io/Portfolio/",
    },
    {
      id: undefined as string | undefined,
